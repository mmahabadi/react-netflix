...
const seedMovies = async () => {
  await prisma.movie.upsert({
    where: { id: "65a11aabc879c8128ac63bb5" },
    update: {},
    create: {
      id: "65a11aabc879c8128ac63bb5",
  ...
  await prisma.movie.upsert({
    where: { id: "65a1262b096bead813ed8c30" },
    update: {},
    create: {
      id: "65a1262b096bead813ed8c30",
      title: "Sintel",
      description:
  ...
  await prisma.movie.upsert({
    where: { id: "65a1267a096bead813ed8c31" },
    update: {},
    create: {
      id: "65a1267a096bead813ed8c31",
  ...
  await prisma.movie.upsert({
    where: { id: "65a12685096bead813ed8c32" },
    update: {},
    create: {
      id: "65a12685096bead813ed8c32",
